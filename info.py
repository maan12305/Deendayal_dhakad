...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1462396507').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002357544388').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002037836704'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002202365910'))  # Bin channel id (make sure bot is admin)
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002170760514'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002037836704'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002315275804')  # Support group id (make sure bot is admin)
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://noname5911315:maanjatt@yuvrajmaan.ypfzoc6.mongodb.net/?retryWrites=true&w=majority&appName=yuvrajmaan")
DATABASE_NAME = environ.get('DATABASE_NAME', "techvjautobottttt")
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+359ueD5No70wM2Zl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/movie_update_channel0')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Im_professor_22')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/movie_update_channel0')
OWNERID = int(os.environ.get('OWNERID', '1462396507'))  # Replace with the actual admin ID
