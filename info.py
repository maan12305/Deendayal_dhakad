...
PICS = (environ.get('PICS', 'https://envs.sh/nvm.jpg https://envs.sh/nvX.jpg')).split() #SAMPLE PIC
...
CODE = (environ.get('CODE', 'https://graph.org/file/890a69b683722940661c1.jpg'))


# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1462396507').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002042843605').split()] #Channel id for auto indexing ( make sure bot is admin )
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002037836704')) #Log channel id ( make sure bot is admin )
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002170760514')) #Notification of those who verify will be sent to your channel. Enter the ID of the channel you want to send notification to here.
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002037836704')) # add premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '') #Channel / Group Id for force sub ( make sure bot is admin )
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002475737629').split()]
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002037836704')) #Log channel id ( make sure bot is admin )
...
SHORTLINK_API = environ.get('SHORTLINK_API', '49fa15ad012b810dc651b13fb12c8a03b6ccf4d6')
...
MSG_ALRT = environ.get('MSG_ALRT', 'ROSSY')
